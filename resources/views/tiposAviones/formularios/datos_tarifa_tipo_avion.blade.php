  ...
  <div class="form-group">
    ...
    {{ isset($codigoTipoAvion) ? $codigoTipoAvion : '' }}
  ...
  <div class="form-group">
      ...
      <div class="col-sm-10">
          {{ Form::select('cod_serv_tipo_avion', $serviciosTipoAvion, null, ['id'=>'cod_serv_tipo_avion', 'class' => 'form-control selectBusqueda', 'placeholder' => trans('copies.generales.seleccione'),  'required'=>'required' ]) }}
      </div>
  </div>
