...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="{{ asset('/themeAdminLte/plugins/iCheck/flat/blue.css') }}">

  <!-- Date Picker -->
  <link rel="stylesheet" href="{{ asset('/themeAdminLte/plugins/datepicker/datepicker3.css') }}">
  <!-- Daterange picker -->
  <link rel="stylesheet" href="{{ asset('/themeAdminLte/plugins/daterangepicker/daterangepicker.css') }}">
  <!-- bootstrap wysihtml5 - text editor -->
  <link rel="stylesheet" href="{{ asset('/themeAdminLte/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css') }}">
  <!-- DataTables -->
  <link rel="stylesheet" href="{{ asset('/themeAdminLte/plugins/datatables/dataTables.bootstrap.min.css') }}">
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    <!-- TITULO DEL CONTENIDO  Content Header (Page header) -->
...
<script src="{{ asset('/themeAdminLte/plugins/daterangepicker/daterangepicker.js') }}"></script>
<!-- datepicker -->
<script src="{{ asset('/themeAdminLte/plugins/datepicker/bootstrap-datepicker.js') }}"></script>
<!-- Bootstrap WYSIHTML5 -->
<script src="{{ asset('/themeAdminLte/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js') }}"></script>
<!-- Slimscroll -->
...
<script src="{{ asset('/themeAdminLte/dist/js/pages/dashboard.js') }}"></script>
