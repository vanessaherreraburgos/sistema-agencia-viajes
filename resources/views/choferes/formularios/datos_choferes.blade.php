...
<fieldset>
    ...
    <div class="row">
        <div class="form-group">
            <div class="col-md-2">
                {{ Form::label('nombre', trans('copies.form_general.nombres').trans('copies.generales.obligatorio'), ['class' => 'col-sm-12 control-label']) }}
            </div>
            <div class="col-md-4">
                {{ Form::text('nombre', '', ['id'=>'nombre', 'class' => 'form-control required', 'placeholder' => trans('copies.form_general.escriba') ]) }}
            </div>
    ...
    <div class="row">
        <div class="form-group">
            <div class="col-md-2">
                {{ Form::label('foto_chofer', trans('copies.form_general.foto'), ['class' => 'col-sm-12 control-label']) }}
            </div>
            <div class="col-md-4">
                {{ Form::file('foto_chofer', ['id'=>'foto_chofer', 'class' => 'form-control-file', 'multiple'=>'true', 'aria-describedby'=>'fileHelp']) }}
...
<fieldset>
    ...
    <div class="row">
        <div class="form-group">
            ...
            <div class="col-md-2">
                {{ Form::label('email', trans('copies.form_general.email').trans('copies.generales.obligatorio'), ['id'=>'email_chofer', 'class' => 'col-sm-12 control-label']) }}
            </div>
            <div class="col-md-4">
...
<fieldset>
    ...
    <div class="row">
        <div class="form-group">
            ...
            <div class="col-md-2">
                {{ Form::label('archivo_licencia', trans('copies.form_general.adjunto_licencia').trans('copies.generales.obligatorio'), ['class' => 'col-sm-12 control-label']) }}
            </div>
            <div class="col-md-4">
                {{ Form::file('archivo_licencia', ['id'=>'archivo_licencia', 'class' => 'form-control-file', 'placeholder' => trans('copies.form_general.escriba'), 'aria-describedby'=>'fileHelp']) }}
                <small id="fileHelp" class="form-text text-muted">
                    {{trans('copies.form_general.text-lic-cond')}}
                </small>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="form-group">
            ...
            <div class="col-md-2">
                {{ Form::label('fecha_vigencia_licencia', trans('copies.form_general.fecha_vig_licencia').trans('copies.generales.obligatorio'), ['class' => 'col-sm-12 control-label']) }}
            </div>
            <div class="col-md-4">
                {{ Form::date('fecha_vigencia_licencia', '', ['id'=>'fecha_vigencia_licencia', 'class' => 'form-control required', 'placeholder' => trans('copies.form_general.escriba') ]) }}
            </div>
        </div>
    </div>
    <div class='clearfix'></div>
    ...
    <!-- Grado de licencia de conducción -->
    <div class="row">
        <div class="form-group">
            <div class="col-md-2">
                {{ Form::label('cod_grado_licencia', trans('copies.form_general.codigo_licencia').trans('copies.generales.obligatorio'), ['class' => 'col-sm-12 control-label']) }}
            </div>
            <div class="col-md-4">
                {{ Form::select('cod_grado_licencia', $grado_licencia, null, ['id'=>'cod_grado_licencia', 'class' => 'form-control select2 required', 'placeholder' => trans('copies.form_general.selecc_licencia') ]) }}
            </div>
