...
@section('title')
    {{trans('copies.breadcrumbs.editar_proveedores')}}
@endsection
...
@section('hist_navegacion')
    @component('components.historial_navegacion')
        @slot('breadcrumbs', [
	        ...
	        "active" 				   => trans('copies.breadcrumbs.editar_proveedores')
	    ])
    @endcomponent
@endsection
          ...
          <div class="ibox-content">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6 col-lg-10">
                {{ Form::text('razon_social', $proveedor->razon_social, ['class' => 'form-control required', 'placeholder' => '', 'maxlength' => '100' ]) }}
              </div>
            </div>
            ...
            <div class="tab-content" id="myTabContent">
              <div class="tab-pane show active" id="contact1" role="tabpanel" aria-labelledby="contact1">
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-6 col-lg-10">
                        {{ Form::text('nombre_propietario1',  $proveedor->nombre_propietario1, ['class' => 'form-control', 'placeholder' => '', 'maxlength' => '50' ]) }}
                      </div>
                  </div>
                  <div class="form-group">
                      {{ Form::label('telefono_propietario1', trans('copies.gestion_proveedores.telefono'), ['class' => 'col-sm-2 control-label']) }}
                      <div class="col-sm-3 col-lg-3">
                        {{ Form::text('telefono_propietario1',  $proveedor->telefono_propietario1, ['class' => 'form-control', 'placeholder' => '', 'maxlength' => '30' ]) }}
                      </div>                
                  </div>
                  <div class="form-group">
                      {{ Form::label('email_propietario1', trans('copies.gestion_proveedores.email'), ['class' => 'col-sm-2 control-label']) }}
                      <div class="col-sm-3 col-lg-3">
                        {{ Form::text('email_propietario1',  $proveedor->email_propietario1, ['class' => 'form-control', 'placeholder' => '', 'maxlength' => '50' ]) }}
                      </div>                
                  </div>            
              </div>
              <div class="tab-pane fade" id="contact2" role="tabpanel" aria-labelledby="contact2">
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-6 col-lg-10">
                        {{ Form::text('nombre_propietario12',  $proveedor->nombre_propietario2, ['class' => 'form-control', 'placeholder' => '', 'maxlength' => '50' ]) }}
                      </div>
                  </div>
                  <div class="form-group">
                      {{ Form::label('telefono_propietario2', trans('copies.gestion_proveedores.telefono'), ['class' => 'col-sm-2 control-label']) }}
                      <div class="col-sm-3 col-lg-3">
                        {{ Form::text('telefono_propietario2',  $proveedor->telefono_propietario2, ['class' => 'form-control', 'placeholder' => '', 'maxlength' => '30' ]) }}
                      </div>                
                  </div>
                  <div class="form-group">
                      {{ Form::label('email_propietario2', trans('copies.gestion_proveedores.email'), ['class' => 'col-sm-2 control-label']) }}
                      <div class="col-sm-3 col-lg-3">
                        {{ Form::text('email_propietario2',  $proveedor->email_propietario2, ['class' => 'form-control', 'placeholder' => '', 'maxlength' => '50' ]) }}
                      </div>                
                  </div>            
              </div>
              <div class="tab-pane fade" id="contact3" role="tabpanel" aria-labelledby="contact3">
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-6 col-lg-10">
                        {{ Form::text('nombre_propietario3',  $proveedor->nombre_propietario3, ['class' => 'form-control', 'placeholder' => '', 'maxlength' => '50' ]) }}
                      </div>
                  </div>
                  <div class="form-group">
                      {{ Form::label('telefono_propietario3', trans('copies.gestion_proveedores.telefono'), ['class' => 'col-sm-2 control-label']) }}
                      <div class="col-sm-3 col-lg-3">
                        {{ Form::text('telefono_propietario3',  $proveedor->telefono_propietario3, ['class' => 'form-control', 'placeholder' => '', 'maxlength' => '30' ]) }}
                      </div>                
                  </div>
                  <div class="form-group">
                      {{ Form::label('email_propietario3', trans('copies.gestion_proveedores.email'), ['class' => 'col-sm-2 control-label']) }}
                      <div class="col-sm-3 col-lg-3">
                        {{ Form::text('email_propietario3',  $proveedor->email_propietario3, ['class' => 'form-control', 'placeholder' => '', 'maxlength' => '50' ]) }}
                      </div>                
                  </div>            
              </div>
            </div>              
...
@section('codigo_scripts')
  <script src="{{ asset('/js/proveedores/editar_proveedores.js') }}"></script>
@endsection
